...
export function updateWidgetData(): void {
  ...
  try {
    ...
    const layoutFn = `function(props, env) {
      ...
      var fS = { $type: 'foregroundStyle', styleType: 'hierarchical', hierarchicalStyle: 'secondary' };
      ...
      function lim(n) { return { $type: 'lineLimit', limit: n }; }
      ...
      if (isSmall || isLock) {
        ...
        var lockFP = isLock ? { $type: 'foregroundStyle', styleType: 'hierarchical', hierarchicalStyle: 'primary' } : fP;
        var lockFS = isLock ? { $type: 'foregroundStyle', styleType: 'hierarchical', hierarchicalStyle: 'secondary' } : fS;
